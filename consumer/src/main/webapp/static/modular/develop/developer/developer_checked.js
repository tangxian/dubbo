...
Developer.initColumn = function () {
    return [
        ...
        {
            title: '分成比例(%)', field: 'divideproportion', visible: true, align: 'center', valign: 'middle',
            formatter: function (value, row, index) {
                return value + '%';
            }
        },
        {title: '状态', field: 'statusName', visible: true, align: 'center', valign: 'middle'},
        {title: '销售模式', field: 'salemodel', visible: true, align: 'center', valign: 'middle'},
        {
...
Developer.search = function () {
    ...
    queryData['salemodel'] = $("#salemodel").val();
    queryData['status'] = 1;
...
$(function () {
    ...
    var ajax = new $ax(Feng.ctxPath + "/dict/selectbyparentcodelist", function (data) {
        ...
        $("#salemodel").html(strHtml);
    }, function (data) {
        Feng.error("页面初始化失败!");
    });
    ajax.set("code", "salemodel");
    ajax.start();
});

...
import com.tangxian.modular.system.model.Menu;
import com.tangxian.modular.system.service.IMenuService;
import com.tangxian.modular.system.warpper.MenuWarpper;
...
public class MenuController extends BaseController {
    ...
    public String menuEdit(@PathVariable Long menuId, Model model) {
        ...
        menuMap.put("pcodeName", constantFactory.getMenuNameByCode(temp.getCode()));
    ...
    public ResponseData add(@Valid Menu menu, BindingResult result) {
        ...
        //判断是否存在该编号
        String existedMenuName = constantFactory.getMenuNameByCode(menu.getCode());

...
import com.tangxian.modular.system.model.Dept;
import com.tangxian.modular.system.service.IDeptService;
import com.tangxian.modular.system.warpper.DeptWarpper;
...
public class DeptController extends BaseController {
    ...
    public String deptUpdate(@PathVariable Integer deptId, Model model) {
        ...
        model.addAttribute("pName", constantFactory.getDeptName(dept.getPid()));
    ...
    public Object delete(@RequestParam Integer deptId) {
        ...
        //缓存被删除的部门名称
        LogObjectHolder.me().set(constantFactory.getDeptName(deptId));

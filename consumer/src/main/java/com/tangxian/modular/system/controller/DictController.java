...
import com.tangxian.modular.system.service.IDictService;
import com.tangxian.modular.system.warpper.DictWarpper;
...
public class DictController extends BaseController {
    ...
    public Object delete(@RequestParam Integer dictId) {
        ...
        //缓存被删除的名称
        LogObjectHolder.me().set(constantFactory.getDictName(dictId));
